...
#define GIT_HASH "ddf5c4f40091b6157164a8846e5b60f42a5ae7f6"
...
#define PACKAGE_STRING "torque 4.2.10"
...
#define PACKAGE_VERSION "4.2.10"

/* Define to the build date */
#define PBS_BUILD_DATE "Wed Apr 29 10:56:21 EDT 2015"

/* Define to the build directory */
#define PBS_BUILD_DIR "/home/guido/git/torque-4.2.10"

/* Define to the build hostname */
#define PBS_BUILD_HOST "aqua"

/* Define to the building username */
#define PBS_BUILD_USER "guido"

/* Define to the install directory */
#define PBS_CFLAGS "-g -D_LARGEFILE64_SOURCE"

/* Define to the install directory */
#define PBS_CONFIG_ARGS " '--prefix=/usr/local/torque'"

/* Define to the name of the default PBS server */
#define PBS_DEFAULT_SERVER "aqua"

/* Define to the install directory */
#define PBS_INSTALL_DIR "/usr/local/torque"

/* the PBS style machine type name */
#define PBS_MACH "linux"

/* Define to the source directory */
#define PBS_SOURCE_DIR "/home/guido/git/torque-4.2.10"
